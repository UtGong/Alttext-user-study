...
export function ResultsFetcher() {
  ...
  return (
    <section className="card researcher-data" aria-labelledby="researcher-data-heading">
      ...
      <p>Fetch every completed study record currently stored in Firestore.</p>
      <AccessibleButton type="button" variant="secondary" onClick={fetchResults} disabled={loading}>
